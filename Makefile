# This Makefile is for the Maypole extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Maypole.pm]
#     AUTHOR => q[Simon Cozens <simon@simon-cozens.org>]
#     NAME => q[Maypole]
#     PREREQ_PM => { Class::DBI::SQLite=>q[0], CGI::Untaint=>q[0], Class::DBI::FromCGI=>q[0.94], Class::DBI::Loader::Relationship=>q[0], Class::DBI::Pager=>q[0], UNIVERSAL::moniker=>q[0], Template=>q[0], URI::QueryParam=>q[0], Class::DBI=>q[0.96], Class::DBI::AsForm=>q[2.2], Template::Plugin::Class=>q[0], Class::DBI::AbstractSearch=>q[0], Class::DBI::Loader=>q[0.02], UNIVERSAL::require=>q[0], Class::DBI::Plugin::RetrieveAll=>q[0], CGI::Simple=>q[0] }
#     VERSION_FROM => q[lib/Maypole.pm]
...
PM_TO_BLIB = lib/Maypole/Config.pm \
	...
	lib/Maypole/Manual/Flox.pod \
	blib/lib/Maypole/Manual/Flox.pod \
	lib/Maypole/Model/CDBI.pm \
	blib/lib/Maypole/Model/CDBI.pm \
	lib/Maypole/Manual/StandardTemplates.pod \
	blib/lib/Maypole/Manual/StandardTemplates.pod \
	lib/Maypole/Model/Base.pm \
	...
	lib/Maypole/Manual/BuySpy.pod \
	blib/lib/Maypole/Manual/BuySpy.pod \
	lib/Maypole/CLI.pm \
	blib/lib/Maypole/CLI.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  lib/Maypole/Config.pm $(INST_MAN3DIR)/Maypole::Config.$(MAN3EXT) \
	  lib/Maypole.pm $(INST_MAN3DIR)/Maypole.$(MAN3EXT) \
	  lib/Maypole/Manual/Model.pod $(INST_MAN3DIR)/Maypole::Manual::Model.$(MAN3EXT) \
	  lib/Maypole/Model/CDBI/Plain.pm $(INST_MAN3DIR)/Maypole::Model::CDBI::Plain.$(MAN3EXT) \
	  lib/Maypole/Constants.pm $(INST_MAN3DIR)/Maypole::Constants.$(MAN3EXT) \
	  lib/Maypole/View/Base.pm $(INST_MAN3DIR)/Maypole::View::Base.$(MAN3EXT) \
	  lib/Maypole/Application.pm $(INST_MAN3DIR)/Maypole::Application.$(MAN3EXT) \
	  lib/Apache/MVC.pm $(INST_MAN3DIR)/Apache::MVC.$(MAN3EXT) \
	  lib/Maypole/View/TT.pm $(INST_MAN3DIR)/Maypole::View::TT.$(MAN3EXT) \
...
metafile :
	...
	$(NOECHO) $(ECHO) '    CGI::Simple:                   0' >> META.yml
	$(NOECHO) $(ECHO) '    CGI::Untaint:                  0' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI:                    0.96' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::AbstractSearch:    0' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::AsForm:            2.2' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::FromCGI:           0.94' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::Loader:            0.02' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::Loader::Relationship: 0' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::Pager:             0' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::Plugin::RetrieveAll: 0' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI::SQLite:            0' >> META.yml
	$(NOECHO) $(ECHO) '    Template:                      0' >> META.yml
	$(NOECHO) $(ECHO) '    Template::Plugin::Class:       0' >> META.yml
	$(NOECHO) $(ECHO) '    UNIVERSAL::moniker:            0' >> META.yml
	$(NOECHO) $(ECHO) '    UNIVERSAL::require:            0' >> META.yml
	$(NOECHO) $(ECHO) '    URI::QueryParam:               0' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="CGI-Simple" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="CGI-Untaint" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI" VERSION="0,96,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-AbstractSearch" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-AsForm" VERSION="2,2,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-FromCGI" VERSION="0,94,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-Loader" VERSION="0,02,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-Loader-Relationship" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-Pager" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-Plugin-RetrieveAll" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI-SQLite" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Template" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Template-Plugin-Class" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="UNIVERSAL-moniker" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Maypole/Config.pm blib/lib/Maypole/Config.pm \
	  lib/Maypole.pm blib/lib/Maypole.pm \
	  lib/Maypole/Manual/Model.pod blib/lib/Maypole/Manual/Model.pod \
	  lib/Maypole/Model/CDBI/Plain.pm blib/lib/Maypole/Model/CDBI/Plain.pm \
	  lib/Maypole/Constants.pm blib/lib/Maypole/Constants.pm \
	  lib/Maypole/View/Base.pm blib/lib/Maypole/View/Base.pm \
	  lib/Maypole/Application.pm blib/lib/Maypole/Application.pm \
	  lib/Apache/MVC.pm blib/lib/Apache/MVC.pm \
	  lib/Maypole/View/TT.pm blib/lib/Maypole/View/TT.pm \
